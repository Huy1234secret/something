...
def main() -> None:
    ...
    class CardSettingsView(discord.ui.View):
        ...
        def to_components(self) -> list[dict[str, Any]]:
            ...
            # A container (type 17) for the button
            button_container = {
                "type": 17,
                "accent_color": accent_color,
                "components": [{"type": 1, "components": base_components}],
            }

            # Layout: Separator, then the container with the button
            return [
                {"type": 1, "components": [{"type": 14, "divider": True, "spacing": 1}]},
                {"type": 1, "components": [button_container]},
            ]
